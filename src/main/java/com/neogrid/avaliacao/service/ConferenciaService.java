...
public class ConferenciaService {
	...
	private List<Conferencia> processarConferencia(List<Palestra> palestrasList) {
		...
		//List<List<Palestra>> listAM = PalestraPeriodoService.alocarPalestrasPeriodo(palestrasList, totalDias, true);
		//List<List<Palestra>> listPM = PalestraPeriodoService.alocarPalestrasPeriodo(palestrasList, totalDias, false);
